...
def parser_args():
    available_models = ['IDA-R50-448', 'IDA-R101-448', 'IDA-R101-512', 'IDA-R101-576', 'IDA-TResL-448', 'IDA-TResL_22k-448', 'IDA-TResL_22k-576', 'IDA-SwinL-384', 'IDA-CvT_w24-384', 'Base-R101-448','SAM-R101-448']
    parser = argparse.ArgumentParser(description='Robust Attention for Contextual Biased Visual Recognition')
