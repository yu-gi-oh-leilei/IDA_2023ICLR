...
def build_backbone_wope(args):
    ...
    return model
               ...
               # pretrained = WEIGHTDICT_V2[name]
                ...
                # print('===='*30)
                # print(pretrained)
            # backbone = torch.hub.load('facebookresearch/semi-supervised-ImageNet1K-models', 'resnext50_32x4d_swsl')
            # backbone = torchvision.models.resnet101(weights=pretrained)
